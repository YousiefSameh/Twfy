 ...
 */
export declare function formatKeyframes(name: string, keyframes: Record<string, any>): string;
/**
 * Format animation utility class
 */
export declare function formatAnimationClass(name: string, animation: string): string;
/**
